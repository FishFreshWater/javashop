...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		SysScheduleEntity scheduleJob = (SysScheduleEntity) context.getMergedJobDataMap()
        		.get(SysScheduleEntity.JOB_PARAM_KEY);
        
        //获取spring bean
        SysScheduleLogService scheduleJobLogService = (SysScheduleLogService) SpringContextUtils.getBean("sysScheduleLogService");
