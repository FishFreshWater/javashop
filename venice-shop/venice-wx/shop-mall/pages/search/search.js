...
Page({
  ...
  getSearchKeyword() {
    let that = this;
    API.methodPost('search', 'SearchIndex').then(function(res) {
      console.log('defaultKeyword',res)
      if (res.code === 0) {
        that.setData({
  ...
  getHelpKeyword: function() {
    let that = this;
    API.methodPost('search', 'SearchHelper', {
  ...
  clearHistory: function() {
    ...
    API.methodPost('search', 'SearchClearHistory')
      .then(function(res) {
        console.log('清除成功');
      });
  },
