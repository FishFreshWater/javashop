package com.plusesb.config.ueditor.hunter;


import com.plusesb.config.cloud.OSSFactory;
import com.plusesb.config.ueditor.PathFormat;
import com.plusesb.config.ueditor.define.*;
import com.plusesb.config.ueditor.upload.StorageManager;
...
public class ImageHunter {
	...
	public State captureRemoteData ( String urlStr ) {
		...
		try {
			...
			String urlS = OSSFactory.build().uploadSuffix(BaseUtils.toByteArray(connection.getInputStream()), this.filename);
