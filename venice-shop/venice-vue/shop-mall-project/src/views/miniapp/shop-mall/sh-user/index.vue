<template>
  <div class="mod-config content pad10">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input size="small" v-model="dataForm.key" placeholder="用户昵称" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      <el-table-column prop="openid" header-align="center" align="center" label="微信id"></el-table-column>
      ...
      <el-table-column prop="lastLoginIp" header-align="center" align="center" label="上次登录ip"></el-table-column>
      <el-table-column prop="lastLoginTime" header-align="center" align="center" label="上次登录时间"></el-table-column>
    </el-table>
    <el-pagination
      class="mar-t10"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/miniapp/shuser/list"),
        method: "get",
        params: this.$http.adornParams({
          pageIndex: this.pageIndex,
          pageSize: this.pageSize,
          nickname_like: this.dataForm.key
        })
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/miniapp/shuser/delete"),
          method: "post",
